...
namespace YoutubeBlog.Web.Filters.PortfolioVisitors
{
    public class PortfolioVisitorFilter : IAsyncActionFilter
    {
        private readonly IUnitOfWork unitOfWork;

        public PortfolioVisitorFilter(IUnitOfWork unitOfWork)
        {
